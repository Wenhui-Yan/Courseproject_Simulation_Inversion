function [rdot,rsot,rddt,rsdt]=PRO4SAIL_needlespec(N,Cab,Car,Cbrown,Cw,Cm,LIDFa,LIDFb,TypeLidf,lai,q,tts,tto,psi,rsoil)
...
% tau	=	LRT(:,3);
% 
% rho(648-400+1,1)=0.0581;
% tau(648-400+1,1)=0.0390;
% 
% rho(858-400+1,1)=0.4839;
% tau(858-400+1,1)=0.4809;
