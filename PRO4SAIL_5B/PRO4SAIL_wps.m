function [rdot,rsot,rddt,rsdt]=PRO4SAIL_kuusk(N,Cab,Car,Cbrown,Cw,Cm,LIDFa,LIDFb,TypeLidf,lai,q,tts,tto,psi,rsoil)
...
rho(648-400+1,1)=0.051496682;
tau(648-400+1,1)=0.02957206;

rho(858-400+1,1)=0.417150822;
tau(858-400+1,1)=0.475894272;
