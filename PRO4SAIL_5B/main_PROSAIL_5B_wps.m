...
rsoil0(648-400+1,1)=0.261509;
rsoil0(858-400+1,1)=0.3655928;
...
for t=1:29*2
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    LAI		=	3.5;     	% leaf area index (m^2/m^2)
    hspot	=	0.05/1.2;       % hot spot
    ...
    [rdot,rsot,rddt,rsdt]=PRO4SAIL_rtec(N,Cab,Car,Cbrown,Cw,Cm,LIDFa,LIDFb,TypeLidf,LAI,hspot,tts,tto,psi,rsoil0);
